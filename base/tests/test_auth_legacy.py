...
from base.services.authentication import GoogleAuthService, InvalidGoogleTokenException
...
class GoogleAuthServiceTests(TestCase):
    ...
    @patch("base.services.authentication.id_token.verify_oauth2_token")
    @patch(
        "base.services.authentication.settings.GOOGLE_CLIENT_ID",
